...
UnderlayMessageType::UnderlayMessageType() 
{
        ...
        m_keyBuffer = (unsigned char*)malloc(UnderlayMessage::getKeyMaxCdrSerializedSize() > 16 ? UnderlayMessage::getKeyMaxCdrSerializedSize() : 16);
}
...
bool UnderlayMessageType::getKey(void* data, InstanceHandle_t* handle) 
{
        ...
        UnderlayMessage* p_type = reinterpret_cast<UnderlayMessage*>(data);
        eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer), UnderlayMessage::getKeyMaxCdrSerializedSize());  // Object that manages
                                                       // the raw buffer.
