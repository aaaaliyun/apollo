...
public:
        ...
        * @param x Reference to the object UnderlayMessage that will be copied.
        */
        ePcyberima_user_DllExport UnderlayMessage& operator=(const UnderlayMessage& x);
        ...
        * @returnsturn Value of member seq
        */
        ...
        */
        ePcyberima_user_DllExport static size_t getMaxCdrSerializedSize(size_t current_alignment = 0);
        ...
        */
        ePcyberima_user_DllExport static size_t getCdrSerializedSize(const UnderlayMessage& data, size_t current_alignment = 0);

        /*!
        * @brief This function serializes an object using CDR serialization.
        * @param cdr CDR serialization object.
        */
        ePcyberima_user_DllExport void serialize(eprosima::fastcdr::Cdr& cdr) const;  // NOLINT

        /*!
        * @brief This function deserializes an object using CDR serialization.
        * @param cdr CDR serialization object.
        */
        ePcyberima_user_DllExport void deserialize(eprosima::fastcdr::Cdr& cdr);  // NOLINT
        ...
        * @return Maximum serialized size.
        */
        ePcyberima_user_DllExport static size_t getKeyMaxCdrSerializedSize(size_t current_alignment = 0);
        ...
        * @param cdr CDR serialization object.
        */
        ePcyberima_user_DllExport void serializeKey(eprosima::fastcdr::Cdr& cdr) const;  // NOLINT
