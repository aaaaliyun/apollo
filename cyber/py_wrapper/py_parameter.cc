...
PyObject* cyber_delete_PyParameter(PyObject* self, PyObject* args) 
{
        ...
        auto* pyparameter = reinterpret_cast<PyParameter*>(PyCapsule_GetPointer(pyobj_param, "apollo_cybertron_pyparameter"));
...
PyObject* cyber_new_PyParameter_int(PyObject* self, PyObject* args) 
{
        ...
        Py_ssize_t len = 0;
        int64_t int_value = 0;
        if (!PyArg_ParseTuple(args, const_cast<char*>("s#L:cyber_new_PyParameter_int"), &name, &len, &int_value)) 
        {
...
PyObject* cyber_new_PyParameter_double(PyObject* self, PyObject* args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char*>("s#d:cyber_new_PyParameter_double"), &name, &len, &double_value)) 
        {
...
PyObject* cyber_new_PyParameter_string(PyObject* self, PyObject* args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char*>("ss:cyber_new_PyParameter_string"), &name, &string_param)) 
        {
...
PyObject* cyber_PyParameter_type_name(PyObject* self, PyObject* args) 
{
        ...
        auto* param = reinterpret_cast<PyParameter*>(PyCapsule_GetPointer(pyobj_param, "apollo_cybertron_pyparameter"));
        if (nullptr == param) 
        {
...
{
        PyObject* pyobj_param = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_PyParameter_debug_string"), &pyobj_param)) 
        {
...
PyObject* cyber_new_PyParameterClient(PyObject* self, PyObject* args) 
{
        ...
        Py_ssize_t len = 0;
        if (!PyArg_ParseTuple(args, const_cast<char*>("Os#:cyber_new_PyParameterClient"), &pyobj_node, &service_node_name, &len)) 
        {
        ...
        PyParameterClient* pyparameter_clt = new PyParameterClient(node, std::string(service_node_name, len));
...
{
        PyObject* pyobj_param = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_delete_PyParameterClient"), &pyobj_param)) 
        {
        ...
        PyParameterClient* pyparameter_clt = reinterpret_cast<PyParameterClient*>(PyCapsule_GetPointer(pyobj_param, "apollo_cybertron_pyparameterclient"));
...
PyObject* cyber_PyParameter_clt_get_parameter(PyObject* self, PyObject* args) 
{
        ...
        Py_ssize_t len = 0;
        PyObject* pyobj_param_clt = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char*>("Os#:cyber_PyParameter_get_parameter"), &pyobj_param_clt, &name, &len)) 
        {
...
{
        PyObject* pyobj_param_clt = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_PyParameter_clt_get_parameter_list"), &pyobj_param_clt)) 
        {
        ...
        auto* pyparam_clt = reinterpret_cast<PyParameterClient*>(PyCapsule_GetPointer(pyobj_param_clt, "apollo_cybertron_pyparameterclient"));
        if (nullptr == pyparam_clt) 
        {
...
{
        PyObject* pyobj_param = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_delete_PyParameterServer"), &pyobj_param)) 
        {
        ...
        PyParameterServer* pyparameter_srv = reinterpret_cast<PyParameterServer*>(PyCapsule_GetPointer(pyobj_param, "apollo_cybertron_pyparameterserver"));
...
PyObject* cyber_PyParameter_srv_get_parameter(PyObject* self, PyObject* args) 
{
        ...
        Py_ssize_t len = 0;
        PyObject* pyobj_param_srv = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char*>("Os#:cyber_PyParameter_get_parameter"), &pyobj_param_srv, &name, &len)) 
        {
                AERROR << "cyber_PyParameter_get_parameter parsetuple failed!";
                Py_INCREF(Py_None);
                return Py_None;
...
{
        PyObject* pyobj_param_srv = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_PyParameter_srv_get_parameter_list"), &pyobj_param_srv)) 
        {
        ...
        auto* pyparam_srv = reinterpret_cast<PyParameterServer*>(PyCapsule_GetPointer(pyobj_param_srv, "apollo_cybertron_pyparameterserver"));
        if (nullptr == pyparam_srv) 
        {
