...
//         PyParameter() 
//         { 
//                 parameter_ = std::make_shared<Parameter>(); 
//         }

//         explicit PyParameter(Parameter* param) 
//         { 
//                 parameter_.reset(param); 
//         }
...
//         {
//                 parameter_ = std::make_shared<Parameter>(name, msg_str, full_name, proto_desc);
//         }
...
// {
// public:
//         PyParameterClient(std::shared_ptr<Node> node, const std::string& service_node_name) 
//         {
...
public:
        ...
        PyParameter(const std::string& name, const int64_t int_value) : parameter_(name, int_value) {}
        PyParameter(const std::string& name, const double double_value) : parameter_(name, double_value) {}
        PyParameter(const std::string& name, const std::string& string_value) : parameter_(name, string_value) {}
        PyParameter(const std::string& name, const std::string& msg_str, const std::string& full_name, const std::string& proto_desc) : parameter_(name, msg_str, full_name, proto_desc) {}
...
{
public:
        PyParameterClient(const std::shared_ptr<Node>& node, const std::string& service_node_name) : parameter_clt_(node, service_node_name) {}
...
{
public:
        explicit PyParameterServer(const std::shared_ptr<Node>& node) : parameter_srv_(node) {}
