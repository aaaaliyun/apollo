...
public:
        ...
        BagMessage ReadMessage(uint64_t begin_time = 0, uint64_t end_time = UINT64_MAX) 
        {
                BagMessage ret_msg;
...
public:
        ...
        {
                return record_writer_.WriteMessage(channel_name, std::make_shared<message::RawMessage>(rawmessage), time, proto_desc);
        }
