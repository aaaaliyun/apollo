...
PyObject *cyber_delete_PyRecordReader(PyObject *self, PyObject *args) 
{
        ...
        auto *reader = reinterpret_cast<PyRecordReader *>(PyCapsule_GetPointer(pyobj_rec_reader, "apollo_cyber_record_pyrecordfilereader"));
        if (nullptr == reader) 
        {
                                                ...
                                                PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os:PyRecordReader_GetMessageNumber"), &pyobj_reader, &channel_name)) 
        {
...
PyObject *cyber_PyRecordReader_GetMessageType(PyObject *self, PyObject *args) 
{
        PyObject *pyobj_reader = nullptr;
        char *channel_name = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os:cyber_PyRecordReader_GetMessageType"), &pyobj_reader, &channel_name)) 
        {
...
PyObject *cyber_PyRecordReader_GetProtoDesc(PyObject *self, PyObject *args) 
{
        PyObject *pyobj_reader = nullptr;
        char *channel_name = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os:PyRecordReader_GetProtoDesc"), &pyobj_reader, &channel_name)) 
        {
...
{
        PyObject *pyobj_reader = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("O:cyber_PyRecordReader_GetHeaderString"), &pyobj_reader)) 
        {
                return PYOBJECT_NULL_STRING;
        }
...
{
        PyObject *pyobj_reader = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("O:cyber_PyRecordReader_GetChannelList"), &pyobj_reader)) 
        {
...
PyObject *cyber_delete_PyRecordWriter(PyObject *self, PyObject *args) 
{
        ...
        auto *writer = reinterpret_cast<PyRecordWriter *>(PyCapsule_GetPointer(pyobj_rec_writer, "apollo_cyber_record_pyrecordfilewriter"));
        if (nullptr == writer) 
        {
...
PyObject *cyber_PyRecordWriter_Open(PyObject *self, PyObject *args) 
{
        ...
        char *path = nullptr;
        Py_ssize_t len = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os#:cyber_PyRecordWriter_Open"), &pyobj_rec_writer, &path, &len)) 
        {
                AERROR << "cyber_PyRecordWriter_Open:PyArg_ParseTuple failed!";
                Py_RETURN_FALSE;
        }

        PyRecordWriter *writer = PyObjectToPtr<PyRecordWriter *>(pyobj_rec_writer, "apollo_cyber_record_pyrecordfilewriter");
...
PyObject *cyber_PyRecordWriter_WriteChannel(PyObject *self, PyObject *args) 
{
        ...
        Py_ssize_t len = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Osss#:cyber_PyRecordWriter_WriteChannel"), &pyobj_rec_writer, &channel, &type, &proto_desc, &len)) 
        {
                AERROR << "cyber_PyRecordWriter_WriteChannel parsetuple failed!";
                Py_RETURN_FALSE;
        }

        auto *writer = PyObjectToPtr<PyRecordWriter *>(pyobj_rec_writer, "apollo_cyber_record_pyrecordfilewriter");
...
PyObject *cyber_PyRecordWriter_WriteMessage(PyObject *self, PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("Oss#Ks#:cyber_PyRecordWriter_WriteMessage"), &pyobj_rec_writer, &channel_name, &rawmessage, &len, &time, &proto_desc, &len_desc)) 
        {
...
PyObject *cyber_PyRecordWriter_SetSizeOfFileSegmentation(PyObject *self, PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("OK:cyber_PyRecordWriter_SetSizeOfFileSegmentation"), &pyobj_rec_writer, &size_kilobytes)) 
        {
                                                             ...
                                                             PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("OK:cyber_PyRecordWriter_SetIntervalOfFileSegmentation"), &pyobj_rec_writer, &time_sec)) 
        {
                AERROR << "cyber_PyRecordWriter_SetIntervalOfFileSegmentation parsetuple failed!";
                Py_RETURN_FALSE;
        }
        ...
        if (nullptr == writer) 
        {
                AERROR << "cyber_PyRecordWriter_SetIntervalOfFileSegmentation:writer ptr is null!";
                Py_RETURN_FALSE;
        }
                                                ...
                                                PyObject *args) 
{
        PyObject *pyobj_rec_writer = nullptr;
        char *channel_name = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os:PyRecordWriter_GetMessageNumber"), &pyobj_rec_writer, &channel_name)) 
        {
                AERROR << "PyRecordWriter_GetMessageNumber:PyRecordWriter_GetMessageNumber failed!";
                return PyLong_FromUnsignedLongLong(0);
        }
...
PyObject *cyber_PyRecordWriter_GetMessageType(PyObject *self, PyObject *args) 
{
        PyObject *pyobj_rec_writer = nullptr;
        char *channel_name = nullptr;
        if (!PyArg_ParseTuple(args,const_cast<char *>("Os:PyRecordWriter_GetMessageType"), &pyobj_rec_writer, &channel_name)) 
        {
...
PyObject *cyber_PyRecordWriter_GetProtoDesc(PyObject *self, PyObject *args) 
{
        PyObject *pyobj_rec_writer = nullptr;
        char *channel_name = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os:PyRecordWriter_GetProtoDesc"), &pyobj_rec_writer, &channel_name)) 
        {
...
static PyMethodDef _cyber_record_methods[] = 
{
        ...
        {"PyRecordWriter_SetSizeOfFileSegmentation", cyber_PyRecordWriter_SetSizeOfFileSegmentation, METH_VARARGS, ""},
        {"PyRecordWriter_SetIntervalOfFileSegmentation", cyber_PyRecordWriter_SetIntervalOfFileSegmentation, METH_VARARGS, ""},
