...
PyObject* cyber_new_PyTimer(PyObject* self, PyObject* args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char*>("kOI:cyber_new_PyTimer"), &period, &pyobj_regist_fun, &oneshot)) 
        {
...
PyObject* cyber_delete_PyTimer(PyObject* self, PyObject* args) 
{
        ...
        auto* pytimer = reinterpret_cast<PyTimer*>(PyCapsule_GetPointer(pyobj_timer, "apollo_cybertron_pytimer"));
        if (nullptr == pytimer) 
        {
...
PyObject* cyber_PyTimer_set_option(PyObject* self, PyObject* args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char*>("OkOI:cyber_PyTimer_set_option"), &pyobj_timer, &period, &pyobj_regist_fun, &oneshot)) 
        {
                Py_INCREF(Py_None);
                return Py_None;
        }
