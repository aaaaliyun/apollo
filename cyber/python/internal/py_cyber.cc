...
PyObject *cyber_new_PyWriter(PyObject *self, PyObject *args) 
{
        ...
        PyWriter *writer = new PyWriter((std::string const &)*channel_name, (std::string const &)*data_type, qos_depth, node);
...
PyObject *cyber_delete_PyWriter(PyObject *self, PyObject *args) 
{
        ...
        PyWriter *writer = reinterpret_cast<PyWriter *>(PyCapsule_GetPointer(writer_py, "apollo_cyber_pywriter"));
        delete writer;
        Py_INCREF(Py_None);
        return Py_None;
}
...
PyObject *cyber_PyWriter_write(PyObject *self, PyObject *args) 
{
        ...
        char *data = nullptr;
        Py_ssize_t len = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os#:cyber_PyWriter_write"), &pyobj_writer, &data, &len)) 
        {
...
PyObject *cyber_new_PyReader(PyObject *self, PyObject *args) 
{
        ...
        char *data_type = nullptr;
        PyObject *node_pyobj = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("ssO:new_PyReader"), &channel_name, &data_type, &node_pyobj)) 
        {
                Py_INCREF(Py_None);
                return Py_None;
        }
        ...
        PyReader *reader = new PyReader((std::string const &)*channel_name, (std::string const &)*data_type, node);
...
PyObject *cyber_delete_PyReader(PyObject *self, PyObject *args) 
{
        ...
        PyReader *reader = reinterpret_cast<PyReader *>(PyCapsule_GetPointer(reader_py, "apollo_cyber_pyreader"));
        delete reader;
        Py_INCREF(Py_None);
        return Py_None;
}
...
PyObject *cyber_PyReader_read(PyObject *self, PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("OO:cyber_PyReader_read"), &pyobj_reader, &pyobj_iswait)) 
        {
...
PyObject *cyber_PyReader_register_func(PyObject *self, PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("OO:PyReader_register_func"), &pyobj_reader, &pyobj_regist_fun)) 
        {
                Py_INCREF(Py_None);
                return Py_None;
        }
...
PyObject *cyber_new_PyClient(PyObject *self, PyObject *args) 
{
        ...
        char *data_type = nullptr;
        PyObject *node_pyobj = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("ssO:new_PyClient"), &channel_name, &data_type, &node_pyobj)) 
        {
                Py_INCREF(Py_None);
                return Py_None;
        }
        ...
        PyClient *client = new PyClient((std::string const &)*channel_name, (std::string const &)*data_type, node);
...
PyObject *cyber_delete_PyClient(PyObject *self, PyObject *args) 
{
        ...
        PyClient *client = reinterpret_cast<PyClient *>(PyCapsule_GetPointer(client_py, "apollo_cyber_pyclient"));
        delete client;
        Py_INCREF(Py_None);
        return Py_None;
}
...
PyObject *cyber_PyClient_send_request(PyObject *self, PyObject *args) 
{
        ...
        char *data = nullptr;
        Py_ssize_t len = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os#:PyClient_send_request"), &pyobj_client, &data, &len)) 
        {
...
PyObject *cyber_new_PyService(PyObject *self, PyObject *args) 
{
        ...
        char *data_type = nullptr;
        PyObject *node_pyobj = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char *>("ssO:new_PyService"), &channel_name, &data_type, &node_pyobj)) 
        {
                Py_INCREF(Py_None);
                return Py_None;
        }
...
PyObject *cyber_delete_PyService(PyObject *self, PyObject *args) 
{
        ...
        PyService *service = reinterpret_cast<PyService *>(PyCapsule_GetPointer(pyobj_service, "apollo_cyber_pyservice"));
        delete service;
        Py_INCREF(Py_None);
        return Py_None;
}
...
PyObject *cyber_PyService_register_func(PyObject *self, PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("OO:PyService_register_func"), &pyobj_service, &pyobj_regist_fun)) 
        {
                Py_INCREF(Py_None);
                return Py_None;
        }
...
PyObject *cyber_PyService_write(PyObject *self, PyObject *args) 
{
        ...
        char *data = nullptr;
        Py_ssize_t len = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os#:cyber_PyService_write"), &pyobj_service, &data, &len)) 
        {
...
PyObject *cyber_PyNode_create_writer(PyObject *self, PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("OssI:PyNode_create_writer"), &pyobj_node, &channel_name, &type_name, &qos_depth)) 
        {
...
PyObject *cyber_PyNode_create_reader(PyObject *self, PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("Oss:PyNode_create_reader"), &pyobj_node, &channel_name, &type_name)) 
        {
...
PyObject *cyber_PyNode_create_client(PyObject *self, PyObject *args) 
{
        ...
        if (!PyArg_ParseTuple(args, const_cast<char *>("Oss:PyNode_create_client"), &pyobj_node, &channel_name, &type_name)) 
        {
        ...
        PyClient *client = reinterpret_cast<PyClient *>((node->create_client((std::string const &)channel_name, (std::string const &)type_name)));
        PyObject *pyobj_client = PyCapsule_New(client, "apollo_cyber_pyclient", nullptr);
...
PyObject *cyber_PyNode_create_service(PyObject *self, PyObject *args) 
{
        ...
        PyService *service = reinterpret_cast<PyService *>((node->create_service((std::string const &)channel_name, (std::string const &)type_name)));
        PyObject *pyobj_service = PyCapsule_New(service, "apollo_cyber_pyservice", nullptr);
        return pyobj_service;
}
...
PyObject *cyber_PyNode_register_message(PyObject *self, PyObject *args) 
{
        ...
        char *desc = nullptr;
        int len = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("Os#:cyber_PyNode_register_message"), &pyobj_node, &desc, &len)) 
        {
...
PyObject *cyber_PyChannelUtils_get_debugstring_by_msgtype_rawmsgdata(PyObject *self, PyObject *args) 
{
        char *msgtype = nullptr;
        char *rawdata = nullptr;
        Py_ssize_t len = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("ss#:cyber_PyChannelUtils_get_debugstring_by_msgtype_rawmsgdata"), &msgtype, &rawdata, &len)) 
        {
                AERROR << "cyber_PyChannelUtils_get_debugstring_by_msgtype_rawmsgdata failed!";
                return PYOBJECT_NULL_STRING;
        }
        std::string raw_data(rawdata, len);
        const std::string debug_string = PyChannelUtils::get_debugstring_by_msgtype_rawmsgdata(msgtype, raw_data);
...
{
        unsigned char sleep_s = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("B:cyber_PyChannelUtils_get_active_channels"), &sleep_s)) 
        {
                                                        ...
                                                        PyObject *args) 
{
        ...
        for (auto &channelinfo : channelsinfo) 
        {
                ...
                {
                        PyList_SetItem(pyobj_list, pos, Py_BuildValue("s#", attr.c_str(), attr.size()));
                        pos++;
                }
...
{
        unsigned char sleep_s = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("B:cyber_PyNodeUtils_get_active_nodes"), &sleep_s)) 
        {
...
PyObject *cyber_PyNodeUtils_get_node_attr(PyObject *self, PyObject *args) 
{
        ...
        Py_ssize_t len = 0;
        unsigned char sleep_s = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("s#B:cyber_PyNodeUtils_get_node_attr"), &node_name, &len, &sleep_s)) 
        {
...
PyObject *cyber_PyNodeUtils_get_readersofnode(PyObject *self, PyObject *args) 
{
        ...
        Py_ssize_t len = 0;
        unsigned char sleep_s = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("s#B:cyber_PyNodeUtils_get_readersofnode"), &node_name, &len, &sleep_s)) 
        {
        ...
        std::string name(node_name, len);
        std::vector<std::string> readers_channel = apollo::cyber::PyNodeUtils::get_readersofnode(name, sleep_s);
...
PyObject *cyber_PyNodeUtils_get_writersofnode(PyObject *self, PyObject *args) 
{
        ...
        Py_ssize_t len = 0;
        unsigned char sleep_s = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("s#B:cyber_PyNodeUtils_get_writersofnode"), &node_name, &len, &sleep_s)) 
        {
        ...
        std::string name(node_name, len);
        std::vector<std::string> writers_channel = apollo::cyber::PyNodeUtils::get_writersofnode(name, sleep_s);
...
{
        unsigned char sleep_s = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("B:cyber_PyServiceUtils_get_active_services"), &sleep_s)) 
        {
...
PyObject *cyber_PyServiceUtils_get_service_attr(PyObject *self, PyObject *args) 
{
        ...
        Py_ssize_t len = 0;
        unsigned char sleep_s = 0;
        if (!PyArg_ParseTuple(args, const_cast<char *>("s#B:cyber_PyServiceUtils_get_service_attr"), &srv_name, &len, &sleep_s)) 
        {
