...
PyObject* cyber_delete_PyTime(PyObject* self, PyObject* args) 
{
        ...
        auto* pytime = reinterpret_cast<PyTime*>(PyCapsule_GetPointer(pyobj_time, "apollo_cybertron_pytime"));
        if (nullptr == pytime) 
        {
...
PyObject* cyber_PyTime_sleep_until(PyObject* self, PyObject* args) 
{
        PyObject* pyobj_time = nullptr;
        uint64_t nanoseconds = 0;
        if (!PyArg_ParseTuple(args, const_cast<char*>("OK:cyber_PyTime_sleep_until"), &pyobj_time, &nanoseconds)) 
        {
...
PyObject* cyber_delete_PyDuration(PyObject* self, PyObject* args) 
{
        ...
        auto* pyduration = reinterpret_cast<PyDuration*>(PyCapsule_GetPointer(pyobj_duration, "apollo_cybertron_pyduration"));
...
PyObject* cyber_delete_PyRate(PyObject* self, PyObject* args) 
{
        ...
        auto* pyrate = reinterpret_cast<PyRate*>(PyCapsule_GetPointer(pyobj_rate, "apollo_cybertron_pyrate"));
        if (nullptr == pyrate) 
        {
...
{
        PyObject* pyobj_rate = nullptr;
        if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_PyRate_get_expected_cycle_time"), &pyobj_rate)) 
        {
                return PyLong_FromUnsignedLongLong(0);
        }
