        ...
        while (!reader_.EndOfFile()) 
        {
                ...
                switch (section.type) 
                {
                        case SectionType::SECTION_CHANNEL: 
                        {
                                ...
                                if (white_channels_.empty() || std::find(white_channels_.begin(), white_channels_.end(), chan.name()) != white_channels_.end()) 
                                {
                        ...
                        case SectionType::SECTION_CHUNK_BODY: 
                        {
                                ...
                                for (int idx = 0; idx < cbd.messages_size(); ++idx) 
                                {
                                        ...
                                        if (std::find(black_channels_.begin(), black_channels_.end(), cbd.messages(idx).channel_name()) != black_channels_.end()) 
                                        {
                                                continue;
                                        }
