...
bool PlayTaskProducer::UpdatePlayParam() 
{
        ...
        {
                play_param_.begin_time_ns += static_cast<uint64_t>(static_cast<double>(play_param_.start_time_s) * 1e9);
        }
...
void PlayTaskProducer::ThreadFunc() 
{
        ...
        auto record_viewer = std::make_shared<RecordViewer>(record_readers_, play_param_.begin_time_ns, play_param_.end_time_ns, play_param_.channels_to_play);
