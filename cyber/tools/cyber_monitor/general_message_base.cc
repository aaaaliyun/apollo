...
int GeneralMessageBase::lineCount(const google::protobuf::Message& msg, int screenWidth) 
{
        ...
        if (!is_folded && field->is_repeated()) 
        {
                ...
                for (int i = 0; i < size; ++i) 
                {
                        switch (field->cpp_type()) 
                        {
                                ...
                                {
                                        const google::protobuf::Message& childMsg = reflection->GetRepeatedMessage(msg, field, i);
                                      ...
                                      unsigned& lineNo, int indent) 
{
        ...
        for (std::size_t i = 0; i < fields.size(); ++i) 
        {
                ...
                {
                        PrintField(baseMsg, msg, jumpLines, s, lineNo, indent, reflection, field, -1);
                }  // end else
        }    // end for
        ...
        #undef OUTPUT_FIELD
                ...
                case google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE:
                {
                        ...
                        GeneralMessageBase::PrintMessage(baseMsg,
                                                         field->is_repeated() ? ref->GetRepeatedMessage(msg, field, index) : ref->GetMessage(msg, field),
