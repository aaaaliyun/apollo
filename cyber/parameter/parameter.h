...
public:
        ...
        */
        template <typename ValueType> typename std::enable_if<std::is_base_of<google::protobuf::Message, ValueType>::value, ValueType>::type
        value() const;
        ...
        */
        template <typename ValueType> typename std::enable_if<std::is_integral<ValueType>::value && !std::is_same<ValueType, bool>::value, ValueType>::type
        value() const;
        ...
        */
        template <typename ValueType> typename std::enable_if<std::is_floating_point<ValueType>::value, ValueType>::type
        value() const;
        ...
        */
        template <typename ValueType> typename std::enable_if<std::is_convertible<ValueType, std::string>::value, const std::string&>::type
        value() const;
...
template <typename ValueType>
typename std::enable_if<std::is_convertible<ValueType, std::string>::value, const std::string&>::type
Parameter::value() const 
{
