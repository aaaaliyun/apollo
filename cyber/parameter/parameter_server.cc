...
ParameterServer::ParameterServer(const std::shared_ptr<Node>& node) : node_(node) 
{
        ...
        get_parameter_service_ = node_->CreateService<ParamName, Param>(FixParameterServiceName(name, GET_PARAMETER_SERVICE_NAME),
        ...
        set_parameter_service_ = node_->CreateService<Param, BoolResult>(FixParameterServiceName(name, SET_PARAMETER_SERVICE_NAME),
        ...
        list_parameters_service_ = node_->CreateService<NodeName, Params>(FixParameterServiceName(name, LIST_PARAMETERS_SERVICE_NAME),
