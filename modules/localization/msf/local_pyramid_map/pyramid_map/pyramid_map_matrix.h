...
public:
        ...
        */
        inline void AddSampleBase(float intensity, float altitude, unsigned int row, unsigned int col, unsigned int level);
        ...
        */
        ...
        inline const float* GetIntensity(unsigned int row, unsigned int col, unsigned int level = 0) const;
        /**@brief Get an intensity variance value by check. */
        inline const float* GetIntensityVar(unsigned int row, unsigned int col, unsigned int level = 0) const;
        ...
        inline const float* GetAltitudeVar(unsigned int row, unsigned int col, unsigned int level = 0) const;
        /**@brief Get an altitude ground value without check. */
        inline const float* GetGroundAltitude(unsigned int row, unsigned int col, unsigned int level = 0) const;
        /**@brief Get a count value without check. */
        inline const unsigned int* GetCount(unsigned int row, unsigned int col, unsigned int level = 0) const;
        /**@brief Get a ground count value without check. */
        inline const unsigned int* GetGroundCount(unsigned int row, unsigned int col, unsigned int level = 0) const;
...
private:
        ...
        bool CheckLegalityForSetDataRoi(unsigned int level, unsigned int source_matrix_rows, unsigned int source_matrix_cols, const Rect2D<unsigned int>& source_roi, const Rect2D<unsigned int>& target_roi) const;
...
inline void PyramidMapMatrix::AddSampleBase(float intensity, float altitude, unsigned int row, unsigned int col, unsigned int level) 
{
                                            ...
                                            unsigned int level) 
{
        ...
        intensity_var_matrixes_[level][row][col] = intensity_var_matrixes_[level][row][col] * p0 + *intensity_var * p1 + intensity_diff * intensity_diff * p0 * p1;
...
inline const float* PyramidMapMatrix::GetIntensity(unsigned int row, unsigned int col, unsigned int level) const 
{
        return &intensity_matrixes_[level][row][col];
}

inline const float* PyramidMapMatrix::GetIntensityVar(unsigned int row, unsigned int col, unsigned int level) const 
{
        return &intensity_var_matrixes_[level][row][col];
}

inline const float* PyramidMapMatrix::GetAltitude(unsigned int row, unsigned int col, unsigned int level) const 
{
        return &altitude_matrixes_[level][row][col];
}

inline const float* PyramidMapMatrix::GetAltitudeVar(unsigned int row, unsigned int col, unsigned int level) const 
{
        return &altitude_var_matrixes_[level][row][col];
}

inline const float* PyramidMapMatrix::GetGroundAltitude(unsigned int row, unsigned int col, unsigned int level) const 
{
        return &ground_altitude_matrixes_[level][row][col];
}

inline const unsigned int* PyramidMapMatrix::GetCount(unsigned int row, unsigned int col, unsigned int level) const 
{
        return &count_matrixes_[level][row][col];
}

inline const unsigned int* PyramidMapMatrix::GetGroundCount(unsigned int row, unsigned int col, unsigned int level) const 
{
