...
void OnlineLocalizationExpert::AddGnssBestPose(const drivers::gnss::GnssBestPose &msg, const MeasureData &data) 
{
        ...
        msf_status_mutex_.lock();
        msf_status_.set_gnsspos_position_type(static_cast<apollo::localization::GnssPositionType>(gnss_status));
        msf_status_mutex_.unlock();
...
void OnlineLocalizationExpert::SetLocalizationStatus(const LocalizationEstimate &data) 
{
        ...
        std::lock_guard<std::mutex> lock(msf_status_mutex_);
        if (position_std.x() < localization_std_x_threshold_1_ && position_std.y() < localization_std_y_threshold_1_) 
        {
        ...
        else if (position_std.x() < localization_std_x_threshold_2_ && position_std.y() < localization_std_y_threshold_2_) 
        {
                switch (msf_status_.gnsspos_position_type()) 
                {
                        case apollo::localization::NARROW_INT:
                        ...
                        case apollo::localization::L1_INT:
                                ...
                                else 
                                {
                                        ...
                                        integ_status_.integ_state = LocalizationIntegState::CRITIAL_ERROR;
                                        integ_status_.state_message = "CRITIAL_ERROR: Current Localization Is Unstable, Lidar Localization is Abnormal";
                                }
                                break;
                        case apollo::localization::FLOATCONV:
                        case apollo::localization::WIDELANE:
                        ...
                        case apollo::localization::NARROW_FLOAT:
                                if (msf_status_.local_lidar_status() == apollo::localization::MSF_LOCAL_LIDAR_NORMAL) 
                                {
                                        ...
                                        integ_status_.integ_state = LocalizationIntegState::CRITIAL_ERROR;
                                        integ_status_.state_message = "CRITIAL_ERROR: Current Localization Is Unstable, GNSS Localization is Abnormal";
                                } 
                                else 
                                {
                                        msf_status_.set_msf_running_status(apollo::localization::MSF_SSOL_X_X);
                                        integ_status_.integ_state = LocalizationIntegState::CRITIAL_ERROR;
                                        integ_status_.state_message = "CRITIAL_ERROR: Current Localization Is Unstable, Both GNSS And Lidar Localization Is Abnormal";
                                }
                                break;
                        case apollo::localization::SINGLE:
                        case apollo::localization::PSRDIFF:
                ...
                switch (msf_status_.gnsspos_position_type()) 
                {
                        ...
                        case apollo::localization::NARROW_FLOAT:
                                if (msf_status_.local_lidar_status() == apollo::localization::MSF_LOCAL_LIDAR_NORMAL) 
                                {
                                        ...
                                        integ_status_.integ_state = LocalizationIntegState::FATAL_ERROR;
                                        integ_status_.state_message = "FATAL_ERROR: Current Localization Is NOT Available, GNSS Localization Is Unstable";
                                } 
                                else 
                                {
                                        msf_status_.set_msf_running_status(apollo::localization::MSF_NOSOL_X_X);
                                        integ_status_.integ_state = LocalizationIntegState::FATAL_ERROR;
                                        integ_status_.state_message = "FATAL_ERROR: Current Localization Is NOT Available, Both GNSS And Lidar Localization Is Unstable";
                                }
                                break;
                        case apollo::localization::SINGLE:
                        case apollo::localization::PSRDIFF:
                                if (msf_status_.local_lidar_status() == apollo::localization::MSF_LOCAL_LIDAR_NORMAL) 
                                {
                                        ...
                                        integ_status_.integ_state = LocalizationIntegState::FATAL_ERROR;
                                        integ_status_.state_message = "FATAL_ERROR: Current Localization Is NOT Available, GNSS Localization Is Abnormal";
                                } 
                                else 
                                {
                                        msf_status_.set_msf_running_status(apollo::localization::MSF_NOSOL_X_XX);
                                        integ_status_.integ_state = LocalizationIntegState::FATAL_ERROR;
                                        integ_status_.state_message = "FATAL_ERROR: Current Localization Is NOT Available, Both GNSS And Lidar Localization Is Abnormal";
                                }
                                break;
                        default:
                                if (msf_status_.local_lidar_status() == apollo::localization::MSF_LOCAL_LIDAR_NORMAL) 
                                {
                                        ...
                                        integ_status_.integ_state = LocalizationIntegState::FATAL_ERROR;
                                        integ_status_.state_message = "FATAL_ERROR: Current Localization Is NOT Available, GNSS Localization Is Invalid";
                                } 
                                else 
                                {
                                        msf_status_.set_msf_running_status(apollo::localization::MSF_NOSOL_X_XXX);
                                        integ_status_.integ_state = LocalizationIntegState::FATAL_ERROR;
                                        integ_status_.state_message = "FATAL_ERROR: Current Localization Is NOT Available, Both GNSS And Lidar Localization Is Invalid";
                                }
                                break;
                }
        }
...
void OnlineLocalizationExpert::GetFusionStatus(MsfStatus *msf_status, MsfSensorMsgStatus *sensor_status, LocalizationIntegStatus *integ_status) 
{
        {
