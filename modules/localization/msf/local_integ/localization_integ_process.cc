...
Status LocalizationIntegProcess::Init(const LocalizationIntegParam &param) 
{
        ...
        sins_->SetImuAntennaLeverArm(gnss_antenna_extrinsic_.translation()(0), gnss_antenna_extrinsic_.translation()(1), gnss_antenna_extrinsic_.translation()(2));
...
void LocalizationIntegProcess::GetValidFromOK() 
{
        ...
        if (pva_covariance_[0][0] < 0.3 * 0.3 && pva_covariance_[1][1] < 0.3 * 0.3 && pva_covariance_[2][2] < 0.3 * 0.3 && pva_covariance_[8][8] < 0.1 * 0.1) 
        {
