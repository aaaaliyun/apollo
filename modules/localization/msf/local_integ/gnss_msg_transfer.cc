...
void GnssMagTransfer::Transfer(const apollo::drivers::gnss::BandObservation& in, BandObservationMsg* out) 
{
        CHECK_NOTNULL(out);
        if (in.has_band_id()) 
        {
...
void GnssMagTransfer::Transfer(const apollo::drivers::gnss::SatelliteObservation& in, SatelliteObservationMsg* out) 
{
        CHECK_NOTNULL(out);
        if (in.has_sat_prn()) 
        {
...
void GnssMagTransfer::Transfer(const apollo::drivers::gnss::EpochObservation& in, EpochObservationMsg* out) 
{
        CHECK_NOTNULL(out);
...
void GnssMagTransfer::Transfer(const apollo::drivers::gnss::KepplerOrbit& in, KepplerOrbitMsg* out) 
{
        CHECK_NOTNULL(out);
        if (in.has_gnss_type()) 
        {
...
void GnssMagTransfer::Transfer(const apollo::drivers::gnss::GlonassOrbit& in, GlonassOrbitMsg* out) 
{
        CHECK_NOTNULL(out);
        if (in.has_gnss_type()) 
        {
...
void GnssMagTransfer::Transfer(const apollo::drivers::gnss::GnssEphemeris& in, GnssEphemerisMsg* out)
{
        CHECK_NOTNULL(out);
        if (in.has_gnss_type()) 
        {
