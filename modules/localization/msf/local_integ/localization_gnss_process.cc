...
void LocalizationGnssProcess::RawObservationProcess(const drivers::gnss::EpochObservation &raw_obs) 
{
        ...
        double leap_second_s = gnss_solver_->get_leap_second(raw_obs.gnss_week(), raw_obs.gnss_second_s());
        ...
        snprintf(message, max_msg_size, "user %u time:%12.3f sat_num:%d obs_delay:%12.3f%16.3f%16.3f%16.3f\n", raw_obs.receiver_id(), raw_obs.gnss_second_s(), raw_obs.sat_obs_num(), obs_delay, obs_xyz[0], obs_xyz[1], obs_xyz[2]);
        AINFO << message;
...
void LocalizationGnssProcess::RawEphemerisProcess(const drivers::gnss::GnssEphemeris &msg) 
{
        ...
        if (gnss_orbit.gnss_type() == drivers::gnss::GnssType::GLO_SYS) 
        {
                ...
                */
                double leap_sec = gnss_solver_->get_leap_second(gnss_orbit.glonass_orbit().week_num(), gnss_orbit.glonass_orbit().toe());
...
void LocalizationGnssProcess::IntegSinsPvaProcess(const InsPva &sins_pva_msg, const double variance[9][9]) 
{
...
LocalizationMeasureState LocalizationGnssProcess::GetResult(MeasureData *gnss_msg) 
{
        ...
        bool b_pos = false;
        if (gnss_pnt_result_.has_pos_x_m() && gnss_pnt_result_.has_pos_y_m() && gnss_pnt_result_.has_pos_z_m()) 
        {
                b_pos = true;
        ...
        bool b_vel = false;
        if (gnss_pnt_result_.has_vel_x_m() && gnss_pnt_result_.has_vel_y_m() && gnss_pnt_result_.has_vel_z_m()) 
        {
                                            ...
                                            double ratio) 
{
        ...
        snprintf(print_infor, sizeof(print_infor), "%6d%12.3f%4d%16.3f%16.3f%16.3f%4d%4.1f%6.1f%8.3f%8.3f%8.3f%8.3f%8.3f%8.3f\n",
