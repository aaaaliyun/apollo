...
void FileUtility::ComputeBinaryMd5(const unsigned char *binary, size_t size, unsigned char res[kUcharMd5Length]) 
{
        MD5 md5;
        md5.init();
...
void FileUtility::ComputeBinaryMd5(const unsigned char *binary, size_t size, char res[kCharMd5Lenth]) 
{
