...
int main(int argc, char **argv) 
{
        ...
        PoseAndStdInterpolationByTime(poses_b, stds_b, timestamps_b, timestamps_a, &out_poses_b, &out_stds_b);

        PoseAndStdInterpolationByTime(poses_a, stds_a, timestamps_a, timestamps_a, &out_poses_a, &out_stds_a);
        ...
        for (unsigned int idx = 0; idx < timestamps_a.size(); idx++) 
        {
                ...
                if (pose_a_found_iter != out_poses_a.end()) 
                {
                        ...
                        apollo::common::math::EulerAnglesZXY<double> euler_a(quatd_a.w(), quatd_a.x(), quatd_a.y(), quatd_a.z());
                        ...
                        if (pose_b_found_iter != out_poses_b.end()) 
                        {
                                ...
                                apollo::common::math::EulerAnglesZXY<double> euler_b(quatd_b.w(), quatd_b.x(), quatd_b.y(), quatd_b.z());
