...
private:
        ...
        inline void QuaternionToEuler(const double quaternion[4], double att[3]) 
        {
                ...
                double dcm22 = quaternion[0] * quaternion[0] - quaternion[1] * quaternion[1] - quaternion[2] * quaternion[2] + quaternion[3] * quaternion[3];
                double dcm01 = 2 * (quaternion[1] * quaternion[2] - quaternion[0] * quaternion[3]);
                double dcm11 = quaternion[0] * quaternion[0] - quaternion[1] * quaternion[1] + quaternion[2] * quaternion[2] - quaternion[3] * quaternion[3];
