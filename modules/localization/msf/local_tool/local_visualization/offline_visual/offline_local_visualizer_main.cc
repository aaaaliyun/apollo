...
int main(int argc, char **argv) 
{
        ...
        bool success = local_visualizer.Init(map_folder, map_visual_folder, pcd_folder, pcd_timestamp_file, gnss_loc_file, lidar_loc_file, fusion_loc_file, extrinsic_file);
        if (!success) 
        {
                return -1;
        }
