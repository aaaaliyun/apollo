...
void LosslessMapCell::SetValueLayer(double altitude, unsigned char intensity, double altitude_thres) 
{
...
LosslessMapMatrix::LosslessMapMatrix(const LosslessMapMatrix& matrix) : BaseMapMatrix(matrix) 
{
