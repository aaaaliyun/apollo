                           ...
                           unsigned char intensity) 
{
        ...
        {
                MapNodeIndex index = MapNodeIndex::GetMapNodeIndex(*map_config_, coordinate, static_cast<unsigned int>(i), zone_id);
                           ...
                           std::vector<unsigned char>* values) 
{
        ...
        MapNodeIndex index = MapNodeIndex::GetMapNodeIndex(*map_config_, coordinate, resolution_id, zone_id);
...
void LosslessMap::GetVarSafe(const Eigen::Vector3d& coordinate, int zone_id, unsigned int resolution_id, std::vector<float>* vars) 
{
        DCHECK_LT(resolution_id, map_config_->map_resolutions_.size());
...
void LosslessMap::GetAltVarSafe(const Eigen::Vector3d& coordinate, int zone_id, unsigned int resolution_id, std::vector<float>* alt_vars) 
{
        DCHECK_LT(resolution_id, map_config_->map_resolutions_.size());
        MapNodeIndex index = MapNodeIndex::GetMapNodeIndex(*map_config_, coordinate,
                                                     resolution_id, zone_id);
...
float LosslessMap::GetVar(const Eigen::Vector3d& coordinate, int zone_id, unsigned int resolution_id) 
{
        DCHECK_LT(resolution_id, map_config_->map_resolutions_.size());
        MapNodeIndex index = MapNodeIndex::GetMapNodeIndex(*map_config_, coordinate,
                                                     resolution_id, zone_id);
...
float LosslessMap::GetVarSafe(const Eigen::Vector3d& coordinate, int zone_id, unsigned int resolution_id) 
{
        DCHECK_LT(resolution_id, map_config_->map_resolutions_.size());
        MapNodeIndex index = MapNodeIndex::GetMapNodeIndex(*map_config_, coordinate,
                                                     resolution_id, zone_id);
...
float LosslessMap::GetAlt(const Eigen::Vector3d& coordinate, int zone_id, unsigned int resolution_id) 
{
        DCHECK_LT(resolution_id, map_config_->map_resolutions_.size());
        MapNodeIndex index = MapNodeIndex::GetMapNodeIndex(*map_config_, coordinate,
                                                     resolution_id, zone_id);
