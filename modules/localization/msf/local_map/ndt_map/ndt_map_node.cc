...
Eigen::Vector3d NdtMapNode::GetCoordinate3D(unsigned int x, unsigned int y, int altitude_index) const 
{
...
void NdtMapNode::Reduce(NdtMapNode* map_node, const NdtMapNode& map_node_new) 
{
        ...
        NdtMapMatrix::Reduce(static_cast<NdtMapMatrix*>(map_node->map_matrix_), static_cast<const NdtMapMatrix&>(*map_node_new.map_matrix_));
}
