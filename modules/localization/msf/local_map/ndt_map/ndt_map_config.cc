...
NdtMapConfig::NdtMapConfig(std::string map_version) : BaseMapConfig(map_version) 
{
...
void NdtMapConfig::LoadXml(boost::property_tree::ptree* config) 
{
        ...
        std::for_each(resolutions_z.begin(), resolutions_z.end(), [this](const boost::property_tree::ptree::value_type& v) 
        {
