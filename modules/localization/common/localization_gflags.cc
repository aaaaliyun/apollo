...
DEFINE_string(lidar_extrinsics_file, "/apollo/modules/localization/msf/params/velodyne_params/velodyne64_novatel_extrinsics_example.yaml",
              "Lidar extrinsics parameter file.");
DEFINE_string(lidar_height_file, "/apollo/modules/localization/msf/params/velodyne_params/velodyne64_height.yaml", 
              "Velodyne extrinsic path for the vehicle in use, where <ros> is the placeholder of ROS root.");
