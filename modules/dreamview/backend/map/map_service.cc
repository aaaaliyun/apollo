...
void MapService::CollectMapElementIds(const PointENU &point, double radius, MapElementIds *ids) const 
{
        if (!MapReady()) 
        {
                return;
...
bool MapService::GetNearestLane(const double x, const double y, LaneInfoConstPtr *nearest_lane, double *nearest_s, double *nearest_l) const 
{
        boost::shared_lock<boost::shared_mutex> reader_lock(mutex_);
                                           ...
                                           const double heading) const 
{
        ...
        if (!MapReady() || HDMap()->GetNearestLaneWithHeading(point, kSearchRadius, heading, kMaxHeadingDiff, nearest_lane, nearest_s, nearest_l) < 0) 
        {
...
bool MapService::GetPoseWithRegardToLane(const double x, const double y, double *theta, double *s) const 
{
        double l;
        LaneInfoConstPtr nearest_lane;
...
bool MapService::ConstructLaneWayPoint(const double x, const double y, routing::LaneWaypoint *laneWayPoint) const 
{
        double s, l;
...
bool MapService::ConstructLaneWayPointWithHeading(const double x, const double y, const double heading, routing::LaneWaypoint *laneWayPoint) const 
{
        double s, l;
        LaneInfoConstPtr lane;
...
bool MapService::CreatePathsFromRouting(const RoutingResponse &routing, std::vector<Path> *paths) const 
{
...
bool MapService::AddPathFromPassageRegion(const routing::Passage &passage_region, std::vector<Path> *paths) const 
{
        if (!MapReady()) 
        {
                return false;
