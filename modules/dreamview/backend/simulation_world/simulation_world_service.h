...
private:
        ...
        */
        ...
        void FindNudgeRegion(const apollo::planning::ObjectDecisionType &decision, const Object &world_obj, Decision *world_decision);
        void UpdateDecision(const apollo::planning::DecisionResult &decision_res, double header_time);
        void UpdateMainStopDecision(const apollo::planning::MainDecision &main_decision, double update_timestamp_sec, Object *world_main_stop);
        ...
        void CreatePredictionTrajectory(const apollo::prediction::PredictionObstacle &obstacle, Object *world_object);
        ...
        */
        ...
        void UpdateLatency(const std::string &module_name, cyber::Reader<MessageT> *reader) 
        {
                ...
                const double sensor_time_sec = apollo::cyber::Time(std::max({header.lidar_timestamp(), header.camera_timestamp(), header.radar_timestamp()})).ToSecond();
        ...
        */
        ...
        std::shared_ptr<cyber::Reader<apollo::perception::TrafficLightDetection>> perception_traffic_light_reader_;
        std::shared_ptr<cyber::Reader<apollo::prediction::PredictionObstacles>> prediction_obstacle_reader_;
