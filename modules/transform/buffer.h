...
public:
        ...
        * tf2::ExtrapolationException, tf2::InvalidArgumentException
        */
        virtual TransformStamped lookupTransform(const std::string& target_frame, const cyber::Time& target_time,
...
private:
        ...
        void SubscriptionCallbackImpl(const std::shared_ptr<const TransformStampeds>& transform, bool is_static);

        void TF2MsgToCyber(const geometry_msgs::TransformStamped& tf2_trans_stamped, TransformStamped& trans_stamped) const;  // NOLINT
