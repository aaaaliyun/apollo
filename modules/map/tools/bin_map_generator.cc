...
int main(int argc, char **argv) 
{
        ...
        ACHECK(apollo::cyber::common::GetProtoFromFile(map_filename, &pb_map)) << "fail to load data from : " << map_filename;
        ...
        pb_map.Clear();
        ACHECK(apollo::cyber::common::GetProtoFromFile(output_bin_file, &pb_map)) << "failed to load map,transform map failed";
