...
public:
        explicit Alignment(std::shared_ptr<JSonConf> sp_conf) 
                : return_state_(ErrorCode::SUCCESS), sp_conf_(sp_conf), sp_good_pose_info_(std::make_shared<BadOrGoodPoseInfo>()), sp_bad_pose_info_(std::make_shared<BadOrGoodPoseInfo>()) {}
