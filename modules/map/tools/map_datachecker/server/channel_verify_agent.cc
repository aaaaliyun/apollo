...
grpc::Status ChannelVerifyAgent::ProcessGrpcRequest(grpc::ServerContext *context, ChannelVerifyRequest *request, ChannelVerifyResponse *response) 
{
...
int ChannelVerifyAgent::AddTopicLack(VerifyResult *result, const std::string &record_path, std::vector<std::string> const &lack_channels) 
{
...
int ChannelVerifyAgent::AddInadequateRate(VerifyResult *result, std::string const &record_path, std::map<std::string, std::pair<double, double>> const &inadequate_rate) 
{
