...
bool ParseNavigationLineFileNames(int argc, char** argv, std::vector<std::string>* navigation_line_filenames) 
{
                               ...
                               NavigationPath* navigation_path) 
{
        ...
        while (std::getline(ifs, line_str)) 
        {
                try 
                {
                        ...
                        bool not_down_sampling = navigator_config.enable_navigator_downsample() ? diff_s >= sample_param.straight_sample_interval() ||
                                                 (diff_s >= sample_param.small_kappa_sample_interval() && std::fabs(current_kappa) > sample_param.small_kappa()) ||
                                                 (diff_s >= sample_param.middle_kappa_sample_interval() && std::fabs(current_kappa) > sample_param.middle_kappa()) ||
                                                 (diff_s >= sample_param.large_kappa_sample_interval() && std::fabs(current_kappa) > sample_param.large_kappa())
                                                : true;
