...
OsInterFace::OsInterFace() : node_(cyber::CreateNode("v2x_os_interface")), init_flag_(false) 
{
...
{
        v2x_obstacle_writer_ = node_->CreateWriter<PerceptionObstacles>(FLAGS_v2x_obstacle_topic);
        if (v2x_obstacle_writer_ == nullptr) 
        {
                AERROR << "Create v2x obstacle writer failed";
                return false;
        }
        v2x_trafficlight_writer_ = node_->CreateWriter<IntersectionTrafficLightData>(FLAGS_v2x_trafficlight_topic);
...
void OsInterFace::GetObstaclesFromOs(const std::shared_ptr<PerceptionObstacles> &msg) 
{
...
void OsInterFace::SendV2xObstaclesToOs(const std::shared_ptr<PerceptionObstacles> &msg) 
{
...
void OsInterFace::SendV2xTrafficLightToOs(const std::shared_ptr<IntersectionTrafficLightData> &msg) 
{
