...
bool ActiveSetQpSolver::Solve() 
{
        ...
        auto ret = qp_problem.init(h_matrix, g_matrix, affine_constraint_matrix, lower_bound, upper_bound, constraint_lower_bound, constraint_upper_bound, max_iter);
        if (ret != qpOASES::SUCCESSFUL_RETURN) 
        {
                ...
                {
                        AERROR << "qpOASES solver failed due to infeasibility or other internal reasons";
                }
                std::stringstream ss;
