...
bool RadarPoints::FillData(const std::shared_ptr<const apollo::drivers::RadarObstacles>& rawData) 
{
        ...
        {
                GLfloat* ptr = buffer_;
                const ::google::protobuf::Map<::google::protobuf::int32, apollo::drivers::RadarObstacle> &radarObstacles = rawData->radar_obstacle();
                for (::google::protobuf::Map<::google::protobuf::int32, apollo::drivers::RadarObstacle>::const_iterator iter = radarObstacles.cbegin(); 
