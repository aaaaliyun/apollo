...
SceneCameraDialog::SceneCameraDialog(QWidget* parent) : QDialog(parent), ui(new Ui::SceneCameraDialog) 
{
        ui->setupUi(this);
        ...
        connect(ui->cameraTypeComboBox, SIGNAL(currentIndexChanged(int)), this, SLOT(onCameraTypeChanged(int)));
