...
public:
        ...
        void UpdateProjection(void) 
        {
                ...
                {
                        projection_mat_.perspective(fov_, near_plane_width_ / near_plane_height_, near_plane_, far_plane_);
                } 
                else 
                {
                        projection_mat_.ortho(-near_plane_width_ / 2.0f, near_plane_width_ / 2.0f, -near_plane_height_ / 2.0f, near_plane_height_ / 2.0f, 0.0f, 0.0f);
                }
        }
